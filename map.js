...
mapboxgl.accessToken = 'pk.eyJ1Ijoic3BpcnVsaW5hIiwiYSI6ImNtaHpmeTcxMzBtYWQyam9scnFsZjNic2cifQ.RS7pXe4YBgCenKGQ_GdQQA';
...
map.on('load', async () => {
  ...
  .style('--departure-ratio', (d) =>
    ...
    .attr('display', d => d.totalTraffic === 0 ? 'none' : 'inline')
  .each(function (d) {
